...
<style>
  ...
  .content{{position:absolute;inset:0;z-index:5;box-sizing:border-box;padding:56px 62px 46px;display:flex;flex-direction:column;justify-content:space-between;}}
  .top{{display:flex;align-items:center;justify-content:space-between;width:100%;}}
  .brand{{display:flex;align-items:center;}}
  .brand img{{height:74px;}}
  .pill{{margin-top:20px;display:inline-block;width:max-content;max-width:100%;background:rgba(255,255,255,0.10);border:2px solid #FFD700;color:#FFD700;font-weight:800;font-size:23px;letter-spacing:3px;text-transform:uppercase;padding:10px 24px;border-radius:50px;font-family:'Montserrat','DejaVu Sans',sans-serif;}}
  .title{{color:#ffffff;font-family:'Anton','DejaVu Sans',sans-serif;font-weight:400;font-size:80px;line-height:1.05;margin:26px 0 0;max-width:1000px;text-shadow:0 4px 22px rgba(0,0,0,0.45);}}
  .title .hl{{color:#FFD700;}}
  .sub{{color:#f0f6fd;font-size:31px;font-weight:600;line-height:1.42;margin:26px 0 0;max-width:1030px;}}
